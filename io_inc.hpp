...
template <typename als_edge_type>
int convert_matrixmarket_inc(std::string base_filename, size_t nodes = 0, size_t edges = 0, int tokens_per_row = 3, int type = TRAINING, int allow_square = true, double percent = 0.5) {
